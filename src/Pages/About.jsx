      ...
      <main className="legal-page">
        <div className="legal-inner">
          <div className="about-hero">
            <h1 className="legal-title">About Zivorah</h1>
            <p className="about-lead">
              Zivorah is a premium jewelry house dedicated to timeless design, refined craftsmanship,
          ...
          <section className="legal-section">
            <h2>Our Story</h2>
            <p>
              Founded with a passion for modern elegance, Zivorah creates jewelry for people who value
          ...
          <section className="legal-section">
            <h2>Craftsmanship</h2>
            <p>
              Each Zivorah piece is thoughtfully designed and finished with care. Our artisans focus on
